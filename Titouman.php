                ...
                <center>
                    ...
                    <div class="underProduct">
                        ...
                        <div id="secondDescription">
                            <h4>DESCRIPTION</h4>
                            <p id="fontDescription" style="color: white">Malgré le fait que beaucoup de producteurs et vendeurs le croient, cette plante n'est pas la même que la Rotala Rotundifolia. La R. rotundifolia a des feuilles rosées à la base et si l'aquarium contient beaucoup de fer celle-ci aura tendance à rougir.

                                La R. Indica quant à elle, à une prétention à rougir beaucoup plus facilement en aquarium non saturé en Fer. Et si l'aquarium a un éclairage puissant et une bonne quantité de Fer, elle prendra des teintes d'un rouge beaucoup plus foncé jusqu'à vineux. </p>
                        </div>
