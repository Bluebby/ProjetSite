                    ...
                    <div class="underProduct">
                        ...
                        <div id="firstDescription">
                            ...
                            <div class="characteristic">
                                ...
                                <div id="fontCharacteristic">42 x 6 x 2,5 cm</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">Etanchéité</h>
                                <div id="fontCharacteristic">IP 67</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">CONSOMMATION</h>
                                <div id="fontCharacteristic">16 WATTS</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">FLUX LUMINEUX</h>
                                <div id="fontCharacteristic">1550 lumens</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">VOULEUR</h>
                                <div id="fontCharacteristic">BLANC</div>
                            </div>
                        ...
                        <div id="secondDescription">
                            <h4>DESCRIPTION</h4>
                            <p id="fontDescription" style="color: white">Elle dispose de 2 rangées de LED d'une puissance de 8 Watts chacune. La première rangée est composée de LED Sunny émettant un flux lumineux de type lumière du jour, et l'autre moitié est composée de LED Plant, avec une température de couleur spécifique aux plantes et à leurs exigences photosynthétiques.

                                La rampe LED Aquel Leddy Slim Duo 16 Watts est conçue pour des aquariums ouverts (sans couvercle) et est 100% étanche pour votre sécurité : si elle venait à tomber dans l'eau, il n'y aurait aucun risque d'électrocution.</p>
                        </div>
