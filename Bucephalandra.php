                    ...
                    <div class="underProduct">
                        ...
                        <div id="firstDescription">
                            ...
                            <div class="characteristic">
                                ...
                                <div id="fontCharacteristic">BORNEO</div>
                            </div>
                            <div class="characteristic">
                        ...
                        <div id="secondDescription">
                            <h4>DESCRIPTION</h4>
                            <p id="fontDescription" style="color: white">Bucephalandra, la plante extraordinaire de Bornéo!

                                Les bucephalandra sont originaires de Bornéo, où malheureusement leur milieu naturel est progressivement détruit par la déforestation.

                                Le bucephalandra est une plante aquatique très rare, particulièrement appréciée en Asie ou elle fait l'objet de collection, on ne compte plus les aquascapeurs passionnés de ce genre d'aracées. </p>
                        </div>
