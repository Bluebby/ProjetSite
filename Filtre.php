                    ...
                    <div class="underProduct">
                        ...
                        <div id="firstDescription">
                            ...
                            <div class="characteristic">
                                ...
                                <div id="fontCharacteristic">600 à 1500 L</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">PROFONDEUR</h>
                                <div id="fontCharacteristic">130mm</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">PUISSANCE</h>
                                <div id="fontCharacteristic">18 Watts</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">PRESSION MAX</h>
                                <div id="fontCharacteristic">0.8 bar</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">COULEUR</h>
                                <div id="fontCharacteristic">GRIS</div>
                            </div>
                        ...
                        <div id="secondDescription">
                            <h4>DESCRIPTION</h4>
                            <p id="fontDescription" style="color: white">Reeflex UV 1500 est un filtre UV pour aquarium d'eau douce ou de mer qui permet agir contre les bactéries nocives, les parasites des poissons et la turbidité de l'eau. Il convient pour des volume d'eau de 700 à 1500 litres.
                            </p>
                        </div>
