  ...
  <div class="contactez-nous">
    ...
    <form action="email.php" method="post" id="Form">
      ...
      <div>
        ...
        <input type="text" id="nom" name="nom" placeholder="Patoche" value=" <?php if (isset($_POST['nom'])) {
                                                                                echo $_POST['nom'];
                                                                              } ?>" required /> <!-- ligne php évite de tout réecrire / required case obligatoirement complété -->

      </div>
      <div>
        <label for="prenom">Votre prénom</label>
        <input type="text" id="prenom" name="prenom" placeholder="Patrick" value="<?php if (isset($_POST['prenom'])) {
                                                                                    echo $_POST['prenom'];
                                                                                  } ?>" required />
      ...
      <div>
        ...
        <input type="email" id="email" name="email" placeholder="monadresse@mail.com" value="<?php if (isset($_POST['Email'])) {
                                                                                                echo $_POST['Email'];
                                                                                              } ?>" required />
      ...
      <div>
        ...
        <textarea id="message" name="message" placeholder="Bonjour, je vous contacte car...." <?php if (isset($_POST['message'])) {
                                                                                                echo $_POST['message'];
                                                                                              } ?> required></textarea>
