                ...
                <center>
                    ...
                    <div class="underProduct">
                        ...
                        <div id="secondDescription">
                            <h4>DESCRIPTION</h4>
                            <p id="fontDescription">Le Polypterus est une espèce démersale. C’est un prédateur qui vit dans les petites rivières, les marais et les zones inondées. Cette espèce semble préférer les bordures abritées. Durant les heures chaudes de la journée, il vient en surface au bord de la végétation, mais rejoint le fond dès qu’il est dérangé. Il se nourrit principalement de poissons, d’insectes, de crustacés, de mollusques, de grenouilles ainsi que de fragments de plantes et de graines.</p>
                        </div>
