                    ...
                    <div class="underProduct">
                        ...
                        <div id="firstDescription">
                            ...
                            <div class="characteristic">
                                ...
                                <div id="fontCharacteristic">8-10cm</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">PH MAXIMUM</h>
                                <div id="fontCharacteristic">7.5</div>
                            </div>
                            <div class="characteristic">
                        ...
                        <div id="secondDescription">
                            <h4>DESCRIPTION</h4>
                            <p id="fontDescription"> La coloration générale est brune, avec, dans les nageoires, des reflets rose-mauve sous un certain éclairage.
                                Sa bouche, largement fendue en arrière, s'ouvre sur le haut, ce qui laisse présumer une alimentation à base d'insectes tombés à l'eau.
                                Ses pectorales particulièrement développées lui permettent de longs sauts.
                                Ses pelviennes sont constitués uniquement de rayons durs, longs d'environ 4 cm, qui pointent vers le bas.
                                Sa dorsale et son anale sont toutes deux placées en retrait et sont assez réduites.
                                La caudale mesure environ 2, parfois 3 cm.</p>
                        </div>
