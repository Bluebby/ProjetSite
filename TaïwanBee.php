                ...
                <center>
                    ...
                    <div class="underProduct">
                        ...
                        <div id="secondDescription">
                            <h4>DESCRIPTION</h4>
                            <p id="fontDescription"> La Blue Bolt est une mutation rare de la CBS, elle est issue d'un croisement à partir d'une Taiwan Bee King Kong. Sa coloration va d'un bleu intense.

                                Le bac d'accueil doit avoir beaucoup de cachettes, être très planté et éventuellement contenir des tubes en céramique. Les plantes qui conviennent particulièrement bien sont la mousse de Java, les cladophora et la fougère de Java ou Microsorum.</p>
                        </div>
