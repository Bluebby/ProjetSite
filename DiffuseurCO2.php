                ...
                <center>
                    ...
                    <div class="underProduct">
                        ...
                        <div id="firstDescription">
                            <div style="width:100%">
                                <h4 style="color: white">CONTENU</h4>
                                </h4>
                            </div>
                            <p id="fontDescription">
                            <div class="characteristic">
                                <h id="tittleCharacteristic">VALVE</h>
                                <div id="fontCharacteristic">Check Valve
                                </div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">Tube</h>
                                <div id="fontCharacteristic">SILLICONE</div>
                            </div>
                            <div class="characteristic">
                                <h id="tittleCharacteristic">REGULATEUR DE PRESSION</h>
                                <div id="fontCharacteristic">CO2 System 74-YA/Ver.2</div>
                            </div>
                        ...
                        <div id="secondDescription">
                            <h4>DESCRIPTION</h4>
                            <p id="fontDescription" style="color: white">Le CO2 Advanced System Forest d'ADA est la nouvelle version moins chère du CO2 System 74. Il comprend l'équipement d'alimentation en CO2 de base pour les aquariums standard de 60 cm. Il contient toutes les pièces nécessaires, telles que le clapet à bille, la résistance à la pression et le tube en silicone, et convient à un débutant dans l'approvisionnement en CO2.</p>
                        </div>
